...
public class LoginActivity extends AppCompatActivity {
    ...
    AppCompatButton mLoginCompatButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatButton=(AppCompatButton)findViewById(R.id.not_a_member_sign_up);
        mLoginCompatButton=(AppCompatButton)findViewById(R.id.login);
        ...
        mLoginCompatButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
