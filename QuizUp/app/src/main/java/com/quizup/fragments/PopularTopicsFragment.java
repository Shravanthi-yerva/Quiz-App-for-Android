...
import com.quizup.R;
import com.quizup.adapter.TopicsAdapter;
...
public class PopularTopicsFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState){
        ...
        mRecyclerView=(RecyclerView)getView().findViewById(R.id.popularTopicsRecyler);
        ArrayList<String> mArrayList =new ArrayList<>();
        //mArrayList.add("Dynamic Programming");
        //mArrayList.add("Electrical Machines");
        //mArrayList.add("DSP");
        ...
        mFirebaseDatabase.getReference("QuizUp").child("Topics").addChildEventListener(new ChildEventListener() {
            @Override
